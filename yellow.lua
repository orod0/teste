...
-- [ THEME - CORRECTED COLORS TO MATCH THE SECOND IMAGE ]
local Keyser = {
    Colors = {
        -- Unified dark blue-gray for the main frame, sidebar, and section headers
        Main        = Color3.fromRGB(30, 32, 40),
        Sidebar     = Color3.fromRGB(30, 32, 40),
        Header      = Color3.fromRGB(30, 32, 40),
        
        -- Lighter background for the content area inside sections
        Content     = Color3.fromRGB(36, 38, 46),
        
        -- Darkest color, used for input fields and list backgrounds
        ValueBox    = Color3.fromRGB(24, 25, 30),

        -- Mid-tones for elements and borders
        Element     = Color3.fromRGB(48, 51, 61),      -- Buttons, slider rails, inactive toggles
        Stroke      = Color3.fromRGB(58, 62, 74),      -- Borders
        Hover       = Color3.fromRGB(58, 62, 74),      -- Hovered buttons (same as stroke)
        Divider     = Color3.fromRGB(58, 62, 74),      -- Line under section header (same as stroke)

        -- Text and Accent colors
        Text        = Color3.fromRGB(210, 212, 220),    -- Bright text
        TextDark    = Color3.fromRGB(130, 134, 148),    -- Dim text
        Accent      = Color3.fromRGB(88, 119, 232)     -- Bright blue for active toggles
    },
...
function Library:Window(Config)
    ...
    function WinData:Tab(Config)
        ...
        local SideBtn = Create("TextButton", {
            Parent = SideContainer, BackgroundColor3 = Color3.fromRGB(30, 30, 35), BackgroundTransparency = 1,
        ...
        function TabObj:Page(Name)
            local TopBtn = Create("TextButton", {
                Parent = TopButtonsFrame, BackgroundColor3 = Color3.fromRGB(30, 30, 35), BackgroundTransparency = 1,
